                    ...
                    <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                        ...
                        <div class="mb-4 px-9">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Value-->
                                <span
                                    class="fs-2hx fw-bolder text-gray-800 me-2 lh-1">{{auth()->user()->Office->Vehicles->count()}}</span>
                                <!--end::Value-->
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Amount-->
                                <span
                                    class="fs-2hx fw-bolder text-dark me-2 lh-1">{{auth()->user()->Office->Orders->count()}}</span>
                                <!--end::Amount-->
                    ...
                    <div class="card-body d-flex align-items-end pt-0">
                        ...
                        <div class="d-flex align-items-center flex-column mt-3 w-100">
                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                <span
                                    class="fw-boldest fs-6 text-dark">{{auth()->user()->Office->current_orders }}
                                    Order to reach the Limit</span>
                                <span
                                    class="fw-bolder fs-6 text-gray-400">{{(auth()->user()->Office->current_orders  / auth()->user()->Office->limit_orders)*100}}%</span>
                            </div>
                            <div class="h-8px mx-3 w-100 bg-light-success rounded">
                                <div class="bg-success rounded h-8px" role="progressbar"
                                    style="width: {{(auth()->user()->Office->current_orders / auth()->user()->Office->limit_orders)*100}}%;"
                    ...
                    <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                        ...
                        <div class="mb-4 px-9">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Value-->
                                <span
                                    class="fs-2hx fw-bolder text-gray-800 me-2 lh-1">{{auth()->user()->office->earnings}}</span>
                                <!--end::Value-->

                            </div>
                            <!--end::Statistics-->
                            <!--begin::Description-->
                            <span class="fs-6 fw-bold text-gray-400">{{__('Total Office Earnings')}} </span>
                            <!--end::Description-->
                        </div>
                        <!--end::Statistics-->
                        <!--begin::Chart-->
                ...
                <div class="card card-flush h-md-50 mb-lg-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <div class="card-title d-flex flex-column">
                            <!--begin::Amount-->
                            <span
                                class="fs-2hx fw-bolder text-dark me-2 lh-1">{{auth()->user()->Office->Drivers->count()}}</span>
                            <!--end::Amount-->
                            <!--begin::Subtitle-->
                    ...
                    <div class="card-body d-flex flex-column justify-content-end pe-0">
                        ...
                        <div class="symbol-group symbol-hover flex-nowrap">
                            @foreach(auth()->user()->Office->Drivers->take(3) as $driver)
                            ...
                            <a href="#" class="symbol symbol-35px symbol-circle" data-bs-toggle="modal"
                                ...
                                <span
                                    class="symbol-label bg-light text-gray-400 fs-8 fw-bolder">{{auth()->user()->Office->Drivers->count() - 3}}
                                    +</span>
                            </a>
                        </div>
                        <!--end::Users group-->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <!--end::Header-->
                    <!--begin::Tab Content-->
                    <div id="" class="tab-content" style="height: 1000">
                        <!--begin::Tab panel-->
                        <div class="card-body p-0 " >
                            <div class="row">
                                <div class="col-md-6 col-offset-3" style="width: 100%;height:100%">
                                    <div class="map-cont" style="width: 100%;height:100%">
                    ...
                    <div id="" class="tab-content">
                        ...
                        <div class="card-body p-0 ">
                            <table id="kt_datatable_example_2" class="table table-striped table-row-bordered gy-5 gs-7">
                                ...
                                <tbody>
                                    @foreach(auth()->user()->office->Orders->take(10) as $order)
                                    <tr>
        ...
        L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 19,
                ...
                function getDrivers(L) {
                    ...
                    $.ajax({
                        "url": "{{route('office.drivers_locations')}}",
