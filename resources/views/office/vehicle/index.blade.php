...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                ...
                <a href="{{route('office.vehicle_create')}}" class="btn btn-primary">
    ...
    <div class="card-body pt-0">
        <table id="kt_datatable_example_2" class="table table-striped table-row-bordered gy-5 gs-3">
            <thead>
            ...
            <tbody>
                @foreach(auth()->user()->Office->Vehicles as $vehicle)
                <tr>
                    <td>{{$vehicle->plate}}</td>
                    ...
                    <td>
						...
						<a href="{{route('office.vehicle_edit',encrypt($vehicle->id))}}" class="btn btn-icon btn-sm btn-warning">
						<i class="bi bi-pencil-fill fs-1x"></i>
                        </a>

                        <a href="{{ route('office.driver_a_modal_cont',encrypt($vehicle->id)) }}" class="btn btn-icon btn-sm btn-warning">
                            <i class="">{{ __('Add Driver') }}</i>
                        </a>
                    </td>
