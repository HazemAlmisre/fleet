...
<div class="card mb-5 mb-xl-10">
									...
									<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
										...
										<div class="card-title m-0">
											<h3 class="fw-bolder m-0">{{__('Travel Mode Create')}}</h3>
										</div>
										<!--end::Card title-->
									</div>
									<!--begin::Card header-->
									...
									<div id="kt_account_settings_profile_details" class="collapse show">
										<!--begin::Form-->
										<form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" method="post" action="{{route('office.travel_mode_store')}}" enctype="multipart/form-data">
                                            {{csrf_field()}}
											<!--begin::Card body-->
											<div class="card-body border-top p-9">
												...
												<div class="row mb-6">
													...
													<div class="col-lg-8 fv-row fv-plugins-icon-container">
														<input type="text" name="title" class="form-control form-control-lg form-control-solid" required placeholder="Title" value="">
												...
												<div class="row mb-6">
													...
													<!--begin::Col-->
													<div class="col-lg-8 fv-row fv-plugins-icon-container">
														<textarea class="form-control form-control-lg form-control-solid" name="description" required id="" cols="30" rows="3"></textarea>
													<div class="fv-plugins-message-container invalid-feedback"></div></div>
													<!--end::Col-->
												</div>
												<!--end::Input group-->
												...
												<div class="row mb-6">
													...
													<!--begin::Col-->
													<div class="col-lg-8 fv-row fv-plugins-icon-container">
														<input type="number" name="price" class="form-control form-control-lg form-control-solid" required placeholder="Price" value="">
													<div class="fv-plugins-message-container invalid-feedback"></div></div>
													<!--end::Col-->
												</div>
												<!--end::Input group-->
												...
												<div class="row mb-6">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" required name="is_active" value="true" id="is_active"/>
												...
												<div class="row mb-6">
                                                    ...
                                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                                        ...
                                                        <input type="text" id="current" hidden  value="0,0" name="current" required>
                                                    </div>
                                                    </div>
													<!--end::Col-->
												</div>
											...
											<div class="card-footer d-flex justify-content-end py-6 px-9">
												<button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">{{__('Create Travel Mode')}}</button>
											</div>
											<!--end::Actions-->
