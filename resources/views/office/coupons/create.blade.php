...
<div class="alert alert-primary">
    ...
    <div class="d-flex flex-column">
        <!--begin::Title-->
        <h4 class="mb-1 text-dark">{{__('Coupon Adding Operation')}}</h4>
        <!--end::Title-->
        <!--begin::Content-->
        <span>{{__('Coupon Added Successfully')}} </span>
        <!--end::Content-->
    </div>
    <!--end::Wrapper-->
</div>
...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{__('Coupon Create')}}</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
            novalidate="novalidate" method="post" action="{{route('office.coupon_store')}}"
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <div class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input" type="checkbox" required name="is_active" value="true"
                                id="is_active" />
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="dicount_type" required class="form-control form-control-lg form-control-solid" id="">
                            ...
                            <option value="1">{{__('number')}}</option>
                        </select>
                    </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="number" name="discount_value" class="form-control form-control-lg form-control-solid"
                            required placeholder="Discount Value" value="">
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">{{__('Create Coupon')}}</button>
            </div>
            <!--end::Actions-->
            <input type="hidden">
            <div></div>
