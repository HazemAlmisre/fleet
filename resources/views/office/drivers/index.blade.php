    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                ...
                <a href="{{route('office.driver_create')}}" class="btn btn-primary">
        ...
        <table id="kt_datatable_example_2" class="table table-striped table-row-bordered gy-5 gs-7">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$start_date[0]}}</td>
                    <td>
                        <a href="{{route('office.driver_view', $driver->id) }}" class="btn btn-icon btn-sm btn-primary">
						<i class="bi bi-eye-fill fs-1x"></i>
                        </a>
						<a href="{{route('office.driver_edit', $driver->id) }}" class="btn btn-icon btn-sm btn-warning">
						<i class="bi bi-pencil-fill fs-1x"></i>
                        </a>
						<a href="{{route('office.driver_delete',$driver->id)}}" class="btn btn-icon btn-sm btn-danger">
						<i class="bi bi-trash-fill fs-1x"></i>
                        </a>
                        <a href="{{route('office.locate_on_map',$driver->id)}}" class="btn btn-icon btn-sm btn-danger">
						<i class="bi bi-pin-fill fs-1x"></i>
                        </a>
