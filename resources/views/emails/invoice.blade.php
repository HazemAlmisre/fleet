        ...
        <td class="container" width="600">
            <div class="content">
                <table class="main" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <td class="content-wrap aligncenter">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr>
                                    <td class="content-block">
                                        <h2>Thanks for using {{config('app.name')}}</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                    ...
                    @endphp
                                            <tbody><tr>
                                                <td>{{$order->Customer->user->name}}<br>Invoice #FAI-321562<br> At Date : {{$start_date[0]}} Time : {{$start_date[1]}}</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr><th>Trip Informations</th></tr>
                                                        <tr>
                                                             <td>Driver</td>
                                                        ...
                                                        <tr><th>Trip Cost Informations</th></tr>

                                                        <tr>
                                                            <td>Trip Est.Distance</td>
                                                        ...
                                                        <tr class="total">
                                                            ...
                                                            <td class="alignright">{{$order->live_price}} SYP</td>
                                                        </tr>
                                                    </tbody></table>
                                                </td>
                                            </tr>
                ...
                <div class="footer no_print">
                    <table width="100%">
                        <tbody><tr>
                            <td class="aligncenter content-block">Questions? Email <a href="mailto:{{App\WebsiteSetting::find(1)->first()->email}}">{{App\WebsiteSetting::find(1)->first()->email}}</a></td>
                        </tr>
                    </tbody></table>
                </div></div>
        </td>
