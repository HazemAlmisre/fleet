                                                        ...
                                                        @if(session('msg'))
                                                            ...
                                                            <div class="alert alert-primary">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <!--end::Title-->
                                                                    <!--begin::Content-->
                                                                    <span>{{__('Driver Added Successfully . you can view the driver profile from')}} <a href="{{route('driver_show',session('driver_id'))}}">{{__('Here')}}</a></span>
                                                                    <!--end::Content-->
                                                                </div>
                                                                <!--end::Wrapper-->
                                                            </div>
...
<div class="card mb-5 mb-xl-10">
									...
									<div id="kt_account_settings_profile_details" class="collapse show">
										<!--begin::Form-->
										<form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" method="post" action="{{route('driver_store')}}" enctype="multipart/form-data">
                                            {{csrf_field()}}
											<!--begin::Card body-->
