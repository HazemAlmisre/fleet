...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
            novalidate="novalidate" method="post" action="{{route('office_update',$office->id)}}"
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true"
                            style="background-image: url('{{$office->logo}}')">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="email" name="email" class="form-control form-control-lg form-control-solid"
                            placeholder="E-mail" value="{{$office->User->email}}">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="password" name="password" class="form-control form-control-lg form-control-solid"
                            placeholder="Password" value="{{$office->User->password}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" name="company" class="form-control form-control-lg form-control-solid"
                            placeholder="Company name" value="{{$office->name}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="tel" name="phone" class="form-control form-control-lg form-control-solid"
                            placeholder="Phone number" value="{{$office->User->phone}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="tel" name="phone1" class="form-control form-control-lg form-control-solid"
                            placeholder="Phone number" value="{{$office->phone1}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="tel" name="phone2" class="form-control form-control-lg form-control-solid"
                            placeholder="Phone number" value="{{$office->phone2}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="tel" name="phone3" class="form-control form-control-lg form-control-solid"
                            placeholder="Phone number" value="{{$office->phone3}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <textarea class="form-control form-control-lg form-control-solid" name="address" id="" cols="30"
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="number" name="km_price" class="form-control form-control-lg form-control-solid"
                            placeholder="KM Price" value="{{$office->km_price}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="number" name="per_min" class="form-control form-control-lg form-control-solid"
                            placeholder="{{__('Price Per Min')}}" value="{{$office->per_min}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="number" name="open_price" class="form-control form-control-lg form-control-solid"
                            placeholder="{{__('Opening Price')}}" value="{{$office->open_price}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="number" name="commission_value"
                            class="form-control form-control-lg form-control-solid" placeholder="Fleet Commission"
                            value="{{$office->commission_value}}">
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="has_travel_mode" required class="form-control form-control-lg form-control-solid"
                            id="">
                            <option value="1" @if($office->has_travel_mode) selected @endif> {{__("True")}}</option>
                            <option value="0"@if(!$office->has_travel_mode) selected @endif>{{__("False")}}</option>
