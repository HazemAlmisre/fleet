...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{__("Edit Vehicle Type")}}</h3>
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
            novalidate="novalidate" method="post" action="{{route('vehicle_update',$vehicle->id)}}"
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" required name="plate" class="form-control form-control-lg form-control-solid"
                            placeholder="Vehicle Plate" value="{{$vehicle->plate}}">
                        @if($errors->has('plate'))
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label
                        class="col-lg-4 col-form-label required fw-bold fs-6">{{__("Vehicle License Number")}}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" required name="license_number"
                            class="form-control form-control-lg form-control-solid" placeholder="Vehicle License Number"
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="office_id" required class="form-control form-control-lg form-control-solid" id="">
                            ...
                            <option value="{{$office->id}}" @if($vehicle->office_id == $office->id) selected
                                @endif>{{$office->name}}</option>
                            @endforeach
                        </select>
                        @if($errors->has('office_id'))
                        <div class="fv-plugins-message-container invalid-feedback">{{ $errors->first('office_id') }}
                        </div>
                        @endif
                    </div>
                    <!--end::Col-->
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="type_id" required class="form-control form-control-lg form-control-solid" id="">
                            ...
                            <option value="{{$type->id}}" @if($vehicle->vehicle_type_id == $type->id ) selected
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="brand_id" required class="form-control form-control-lg form-control-solid" id="">
                            ...
                            <option value="{{$brand->id}}" @if($vehicle->vehicle_brand_id == $brand->id ) selected
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <select name="model_year" required class="form-control form-control-lg form-control-solid"
                            ...
                            @for($year = 2000; $year < date("Y"); $year++ ) <option value="{{$year}}" @if($vehicle->
                                model_year == $year) selected @endif>{{$year}} </option>
                                @endfor
                        </select>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" value="{{$vehicle->model}}" class="form-control form-control-lg form-control-solid" name="model"
                            required>
                        @if($errors->has('model'))
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" value="{{$vehicle->color}}" class="form-control form-control-lg form-control-solid" name="color"
                            required>
                        @if($errors->has('color'))
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <button type="submit" class="btn btn-primary"
                    id="kt_account_profile_details_submit">{{__("Update Vehicle Informations")}}</button>
            </div>
            <!--end::Actions-->
            <input type="hidden">
            <div></div>
