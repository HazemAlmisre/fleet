    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                ...
                <a href="{{route('vehicle_types_create')}}" class="btn btn-primary">
                    ...
                    <!--end::Svg Icon-->{{__("Add Vehicle Type")}}</a>
    ...
    <div class="card-body pt-0">
        <table id="kt_datatable_example_2" class="table table-striped table-row-bordered gy-5 gs-7">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$type->name}}</td>
                    <td><img src="{{$type->image}}" style="width:50px" class="img-thumbnail" alt=""></td>
                    <td>{{$type->Vehicles->count()}}</td>
                    @php
                    $start_date = explode(" ",$type->created_at);
                    @endphp
                    <td>{{$start_date[0]}}</td>
                    <td>
                       
						<a href="{{route('vehicle_types_edit',$type->id)}}" class="btn btn-icon btn-sm btn-warning">
