    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                ...
                <a href="{{route('position_create')}}" class="btn btn-primary">
                    ...
                    <!--end::Svg Icon-->{{__('Position List')}}</a>
        ...
        <table id="kt_datatable_example_2" class="table table-striped table-row-bordered gy-5 gs-7">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$position->name}}</td>
                    <td>
						<a href="{{route('position_delete',$position->id)}}" class="btn btn-icon btn-sm btn-danger">
